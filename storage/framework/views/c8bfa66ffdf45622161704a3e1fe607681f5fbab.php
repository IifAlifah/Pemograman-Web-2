                        ...
                        <div class="col-md-5 border rounded mt-2">
                            <form action="<?php echo e(route('dashboard.update', $users->id)); ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_input" name="namaInput" value="<?php echo e($users->name); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="email_input" class="form-label">Email</label>
                                    <input type="text" class="form-control" id="email_input" name="emailInput" value="<?php echo e($users->email); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="password_input" class="form-label">Password</label>
                                    <input type="text" class="form-control" id="password_input" name="passwordInput" value="<?php echo e($users->password); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="is_admin_input" class="form-label">Is_admin</label>
                                    <input type="text" class="form-control" id="is_admin_input" name="is_adminInput" value="<?php echo e($users->is_admin); ?>">
                                </div>
                                <div class="row mx-2">
...
<?php /**PATH C:\xampp\htdocs\Tugas4\resources\views/editUser.blade.php ENDPATH**/ ?>