                ...
                <div class="container ">
                    <div class="row justify-content-center">
                        <div class="col-md-5 border rounded mt-2">
                            <form action="<?php echo e(route('laptop.update', $laptop->id)); ?>" method="POST">
                                <?php echo method_field('put'); ?>
                                <?php echo csrf_field(); ?>
                        
                                <div class="mb-3">
                                    <label for="merk_input" class="form-label">Merk</label>
                                    <input type="text" class="form-control" id="merk_input" name="merkInput" value="<?php echo e($laptop->merk); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="tipe_input" class="form-label">Tipe</label>
                                    <input type="text" class="form-control" id="tipe_input" name="tipeInput" value="<?php echo e($laptop->tipe); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi_input" class="form-label">Deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi_input" name="deskripsiInput" value="<?php echo e($laptop->deskripsi); ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="harga_input" class="form-label">Harga</label>
                                    <input type="text" class="form-control" id="harga_input" name="hargaInput" value="<?php echo e($laptop->harga); ?>">
                                </div>
...
<?php /**PATH C:\xampp\htdocs\Tugas4\resources\views/editLaptop.blade.php ENDPATH**/ ?>