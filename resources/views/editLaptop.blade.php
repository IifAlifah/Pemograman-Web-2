                        ...
                        <div class="col-md-5 border rounded mt-2">
                            <form action="{{ route('laptop.update', $laptop->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="merk_input" name="merkInput" value="{{ $laptop->merk }}">
                                </div>
                                <div class="mb-3">
                                    <label for="tipe_input" class="form-label">Tipe</label>
                                    <input type="text" class="form-control" id="tipe_input" name="tipeInput" value="{{ $laptop->tipe }}">
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi_input" class="form-label">Deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi_input" name="deskripsiInput" value="{{ $laptop->deskripsi }}">
                                </div>
                                <div class="mb-3">
